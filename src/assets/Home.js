...
let Home = ()=>{
    ...
    return (
        ...
        <h3 style={{color:'white'}}>Here You Can Create and Share Your Blog...</h3>
        <h1 style={{color:'yellow'}}><span style={{color:'red'}}>Create</span><i> Your Own Blog </i><span style={{color:'green'}}>With Us</span></h1>
